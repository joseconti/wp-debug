...
function display_wpdebug_main_settings_panel_fields() {
	add_settings_section( 'wpdebug-main-settings-section', null, null, 'wpdebug-main-settings-options' );
	add_settings_field( 'wpdebug_activate_page_menubar_field', esc_html__( 'Show Screen in Menubar', 'wp-debug' ), 'wpdebug_activate_page_menubar_field', 'wpdebug-main-settings-options', 'wpdebug-main-settings-section' );
