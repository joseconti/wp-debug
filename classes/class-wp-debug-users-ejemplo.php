...
class WP_Debug_Users {
	...
	public function __construct() {
		add_action( 'show_user_profile', array( $this, 'add_email_fields' ) );
		add_action( 'edit_user_profile', array( $this, 'add_email_fields' ) );
	 ...
	 */
	public function add_email_fields( $profileuser ) {
